...
## BATCH 14 — คดีร.4–ร.5 fixes + คดีปล้นพระสงฆ์วัดจอมสุดา 2440 (21 Aug 2026)

**Commit:** 5296b4e | **Deployed:** live (4 pages verified HTTP 200) | **Validated:** 270 A/A_REVIEW — 39 WARN (pre-existing ICJ + maaekaa override), 0 BLOCK

### Fixes (Agent C handoff + content audit)

| คดี | แก้ไข | สถานะ |
|---|---|---|
| กบฏบวรเดช 2476 (A/90) | ผลพิจารณา: ประหาร 5 → **6 คน**; รวมรับโทษ 154 → **244 คน** (พิจารณา 296, 46 คนปลอดต่อ, 13 หนีไปฝรั่ งเศสอินโดจีน: บวรเดช เทพสงคราม ฯลฯ) — ตรงตามผลตรวจ รชก. (Agent C) | A คงเดิม |
| อีหยู่ หีบเหล็ก (A/88) | Timeline ประหารชีวิต: พ.ศ. 2461 → **2462** (19 ส.ค. 2462 ตัดคอ ลานวัดภาษี — นักโทษชายคนสุดท้ายที่ถูกตัดคอ) | A คงเดิม |
| พระปรีชากลการ 2421 (A/89) | Summary: 15,500 **ชั่ ง** (ไม่ใช่ ช่าง); ลำดับเรื่องผิด (สมเด็จเจ้าพระยาฯ กราบทูล ร.5 ไม่ใช่ 'ถูกร.5 ฟ้อง'); 'จบประหาร 2422' → 'สิ้นชีวิตนแนคุก 2422'; ชื่อ 'บรมมหาศรีศุริยวงษ์/กราบทูล' → **บรมมหาศรีศุริยวงษ์** และ **กราบทูล** (title + summary + body, 3 แห่ ง) | A คงเดิม |

### คดีใหม่

| คดี | คะแนน | แหล่ง | หมายเหตุ |
|---|---|---|---|
| ปล้นพระสงฆ์วัดจอมสุดา 2440 (ร.5) — ยิงศิษย์วัดตายกลางกุฏิ | A/85 | JOS SWU (ชาลี เอี่ยมกระสินธุ์ 2558 ผ่าน JOS vol.19 2559, PDF หน้า 78) | primary source เดียว — ควรทวนสอบหากพบข้อมูลเพิ่ม; provisions = จารีตนครบาล/พระอัยการอาญาหลวง (external_law); video_status=pending → TODO_VIDEOS.md |

### สรุปตัวเลข

- Processed: 4 | Fixed: 3 | New: 1
- **A total: 270** (A=266 + A_REVIEW=4) | BLOCK: 0
- Video Pending: 1 (วัดจอมสุดา 2440) | Judicial Potential: 0 new
